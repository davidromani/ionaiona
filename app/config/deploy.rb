...
# Config #
##########
set :application,       "Iona Iona"
set :domain,            "s3.flux.cat"
set :deploy_to,         "/home/flux/webapps/ionaiona"
set :app_path,          "app"
set :cache_dir,         "/cache"
...
# SCM Repository #
##################
set :repository,        "git@github.com:davidromani/ionaiona.git"
set :scm,               :git
set :branch,            "master"
...
set :shared_children,   [ app_path+logs_dir, app_path+sessions_dir, web_path+bundles_dir, web_path+uploads_dir, web_path+media_dir ]

###############
# Permissions #
###############
set :writable_dirs,         [ app_path+cache_dir, app_path+logs_dir, app_path+sessions_dir, web_path+bundles_dir, web_path+uploads_dir, web_path+media_dir ]
